...
class SuperAlertController {
    ...
    public SuperAlertController(Context context, AppCompatDialog di, Window window) {
        mContext = context;
        mDialog = di;
        mWindow = window;
    ...
    public static class AlertParams {
        ...
        public void apply(SuperAlertController dialog) {
            if (mCustomTitleView != null) {
        ...
        private void createListView(final SuperAlertController dialog) {
